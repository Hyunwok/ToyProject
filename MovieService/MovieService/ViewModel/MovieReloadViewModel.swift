...
class MovieReloadViewModel {
    ...
    func loadView(url: String) -> Observable<[List]> {
        
        return Observable<[List]>.create { observer in
            ...
            let requset = AF.request(url, method: .get).responseData { response in
                ...
                case .success(let json):
                    do {
                        ...
                        let resultList = model.boxOfficeResult
                        let finalResult = resultList.dailyBoxOfficeList
